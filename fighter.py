...
class Fighter():
  ...
  def move(self, screen_width, screen_height, surface, target, round_over, key = ""):
    ...
    if self.attacking == False and self.alive == True and round_over == False:
      ...
      if self.player == 1:
        ...
        if key == "__1A":
          ...
          self.running = True
        #jump
        elif key == "__1W" and self.jump == False:
          self.vel_y = -30
          self.jump = True
        #attack
        elif key in ["__1R", "__1T"]:
          self.attack(target)
      ...
      if self.player == 2:
        ...
        if key == "__2A":
          ...
          self.running = True
        #jump
        elif key == "__2W" and self.jump == False:
          self.vel_y = -30
          self.jump = True
        #attack
        elif key in ["__2R", "__2T"]:
          self.attack(target)
          #determine which attack type was used
          if key == "__2R":
            self.attack_type = 1
    ...
    if self.rect.bottom + dy > screen_height * 91 // 108:
      self.vel_y = 0
      self.jump = False
      dy = screen_height * 91 // 108 - self.rect.bottom
